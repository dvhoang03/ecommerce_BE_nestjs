...
@Injectable()
export class IsVoucherHasOrderValidator implements ValidatorConstraintInterface {

    constructor(private readonly voucherService: VoucherService) { }

    async validate(voucherId: number, validationArguments?: ValidationArguments): Promise<boolean> {
